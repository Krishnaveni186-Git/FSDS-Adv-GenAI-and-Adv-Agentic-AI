...
model = pickle.load(open(r'C:\Users\user\VSCode\Machine Learning\Regression\SLR_Models\Salary_prediction_model.pkl', 'rb'))

# Set the title of the Streamlit app
st.title("Salary Prediction App created by Krishnaveni")
...
st.write("The model was trained using a dataset of salaries and years of experience built model by Krishnaveni")